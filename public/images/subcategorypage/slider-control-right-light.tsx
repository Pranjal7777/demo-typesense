...
const SliderRightLightSVG = () => {
  return (
    <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="52" height="52" rx="26" fill="black" fillOpacity="0.39" />
      <mask id="mask0_2363_38419" style={{maskType:'alpha'}} maskUnits="userSpaceOnUse" x="8" y="8" width="36" height="36">
...
export default SliderRightLightSVG;
