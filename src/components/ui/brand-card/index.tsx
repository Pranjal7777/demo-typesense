...
const BrandCard: React.FC<BrandCardProps> = ({ imageUrl, title }) => {
  return (
    <div className="min-w-[68px] min-h-[102px] sm:min-w-[96px] sm:min-h-[137px]  border-error flex flex-col items-center ">
      <div className=" border border-border m-1 sm:m-2 p-2 bg-bg-secondary-light shadow-lg w-[60px] sm:w-[80px] h-[60px] sm:h-[80px] rounded-full flex items-center justify-center hover:cursor-pointer hover:scale-105 transition-all duration-100 ease-in">
