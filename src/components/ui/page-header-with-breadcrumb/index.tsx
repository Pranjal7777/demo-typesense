...
const PageHeaderWithBreadcrumb: FC<PageHeaderWithBreadcrumbProps> = ({ steps, className, slugDetail, listClassName }) => {
  ...
  return (
    <div className={appClsx('z-[1] max-h-[69px] mobile:max-h-[50px] h-full max-w-full w-full bg-bg-secondary-light dark:bg-bg-primary-dark !fixed top-[69px] px-16 mobile:px-4 overflow-hidden', className)}>
