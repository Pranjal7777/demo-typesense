...
const SellerProfile: FC<Props> = ({ sellerProfileData, followCountData }) => {
  ...
  console.log(sellerProfileData, 'sellerProfileData');
  ...
  return (
    <>
      <CustomHeader
      url={sellerProfileData?.profileLink}
        keywords={`${sellerProfileData?.firstName} ${sellerProfileData?.lastName}`}
        image={sellerProfileData?.profilePic || ''}
        title={sellerProfileData?.firstName + ' ' + sellerProfileData?.lastName}
        description={`Explore the profile of ${sellerProfileData?.firstName} ${sellerProfileData?.lastName}, a trusted seller offering high-quality products on YourSiteName. Discover ratings, reviews, and product listings.`}
      />
          ...
          <div className="profile text-text-primary-light dark:text-text-primary-dark w-full px-[4%] md:px-[64px] mx-auto max-w-[1440px] border-t py-[20px] flex flex-col md:flex-row gap-x-[16px]">
            ...
            <div className="right flex-1">
              ...
              <div className="content w-full md:pl-0 md:p-[20px] md:border text-text-primary-light dark:text-text-primary-dark border-border-tertiary-light dark:border-border-tertiary-dark mt-[20px] rounded-t-[12px]">
                <div className="pb-[20px] md:flex hidden justify-between items-center">
